...
- **Agent Harness Comparison** *(WIP)* - Experimenting with agent harnesses (eg OpenSpec, OpenCode) looking for sustainable ways to build and maintain software efficiently with the assistance of AI. Also comparing subscription LLMs to local LLMs.
...
*Stack: Copilot, Kotlin, Ktor, Exposed, PostgreSQL, SpiceDB, Automerge, TypeScript, React*
