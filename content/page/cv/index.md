...
OneTeam Services is building a SaaS platform for business process automation, enabling organisations to define and run complex workflows through a no-code workspace model.
...
Kotlin (preferred), Java, Spring Boot, Ktor, Exposed, React, TypeScript, Node.js

**Data**
PostgreSQL, Apache Spark, JPA, SpiceDB

**Architecture & Design**
Clean architecture, domain modelling, REST/HATEOAS, microservices, ReBAC, CRDT

**Testing**
TDD, BDD, JBehave, JUnit, Selenium, Thucydides

**Tooling & Platforms**
Git, Gradle, Maven, IntelliJ IDEA, Heroku, AWS
...
Technical writing covering Kotlin, software design, and development practice.
