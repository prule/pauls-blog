...
Lets bling it up with comments so we can explain what's going on:
...
Now let's pretend the snippet originated in a TypeScript or JavaScript file - we can copy it to a Json5 file without modification -
