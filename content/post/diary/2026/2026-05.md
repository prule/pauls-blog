...
* [Ktor + Kotlin Multiplatform: Full-Stack Type-Safe Development](https://slicker.me/kotlin/ktor-kmp.html)
* [A fireside chat on the evolution of the developer craft](https://www.youtube.com/watch?v=VTYx7Ex-0bA) Speakers: Addy Osmani, Richard Seroter, Aja Hammerly, Ciera Jaspan
* [The Interactive Handbook on Data Structures and Algorithms](https://cartesian.app) This one-of-a-kind interactive book offers a hands-on approach to learning data structures and algorithms, featuring rich visualizations, code execution playback, an assortment of problems and an embedded Python environment. It’s designed to support both beginners and more experienced learners through active exploration and interactivity.
...
* [A Blast from the Past: SDD and the Software Factory](https://open.substack.com/pub/adamtornhill/p/a-blast-from-the-past-sdd-and-the?r=3ieyr&utm_medium=ios)
...
* [Fundamentals of AI System Architecture](https://deepengineering.substack.com/p/fundamentals-of-ai-system-architecture?utm_campaign=post&utm_medium=web&triedRedirect=true)
...
* [Metapatterns GitHub Repository](https://github.com/denyspoltorak/metapatterns)
    + A repository exploring structural abstractions and software design metapatterns.
* [LinkedIn Text Formatter](https://typegrow.com/tools/linkedin-text-formatter)
