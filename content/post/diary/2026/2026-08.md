...
* [Claude Code: Building Production Agents That Actually Scale (Leanpub)](https://leanpub.com/claude-code-building-production-agents-that-actually-work)
  + Thomas De Vos's 518-page guide to the full production stack for Claude agents - tools, permissions, MCP servers, evals, observability and cost controls - drawing on real-world experience from regulated financial institutions across 31 chapters plus practical appendices.
